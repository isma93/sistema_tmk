...
<br>
<br><form onsubmit="retrofilnull(event)" action="./AppCode/password.php" id="nullfill" method="post" class="invoice-form" role="form" novalidate>
<div class="container">
<div class="panel panel-danger">
														...
														<center><table class="table-borderless">
															<tr>
														<th width="100%" colspan="2"><span> Ingrese Contraseña Actual:</span></th>
														</tr><tr>											
														
														
														
														<th width="90%"><input id="actual" type="password" value=""class="form-control" name="actual"  placeholder="Contraseña actual" autocomplete="off"></th>
