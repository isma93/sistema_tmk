...
<div class="topnav" id="myTopnav" >
 ...
 $modulo_aut='<a  href="#"><i class="fa fa-book" aria-hidden="true"></i> Módulo de Autorizaciones</a>'; 
 $reportes='<a class="active" href="../../Reporting/Report_master.php"><i class="fa fa-line-chart" aria-hidden="true"></i> Reportes</a>';
...
<div class="load-animate animated fadeInUp">
			...
			<center><h3>Pendientes de autorizar de bodega</h3></center>
			</div>		    		
			</div>
