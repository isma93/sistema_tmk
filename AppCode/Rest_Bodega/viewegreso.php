...
<div class="topnav" id="myTopnav" >
 ...
 $modulo_aut='<a  href="ViewAut.php"><i class="fa fa-book" aria-hidden="true"></i> Modulo de Autorizaciones</a>'; 
...
<?php
			...
			<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
				...
				<th width="50%"><input <?php if ($key==true){} else {echo "disabled";}?> id="confirmado" data-loading-text="Guardando factura..." type="submit" name="confirmado" value="Confirmar Nota Revisada" class="tn btn-success btn-lg btn-block">	
					...
					<th width="50%">	<input  <?php if ($key2==true){} else {echo "disabled";} ?>  id="anulado" data-loading-text="Guardando factura..." type="submit" name="anulado" value="Anular Nota" class="tn btn-danger	 btn-lg btn-block">											
																			</th>	
																			</tr>
																			</table>
			</div>
