...
<body>
  ...
  <div class="app-content">
    <div class="app-content-header">
      ...
      <h1 class="app-content-headerText">Compras</h1>
    ...
    <div class="bordes_botones_derechos">
        <div class="Group_botones_derechos_compras">
          <a onclick="recorrido_tabla();" type="submit" class="tn bg-warning btn-lg btn-block" id="btn_facturar">
            <h4 class="themelight"><i onclick="" id="" class="fa fa-shopping-cart"></i> Compra F2</h5>
          </a></span>
          ...
          <option value="0" selected>Selecciona...</option>
           ...
           <br>
              <input readonly type="text" placeholder="SURCURSAL" class="form-control" id="txtSelectSurcusal">
              <br>
              <input type="text" placeholder="N° Documento" class="form-control" id="txtdocumento">
  ...
  var ultm=""; 
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            else 
            {
                  ...
                  var txtnum_documento = document.getElementById("txtdocumento").value;
                  if (txtnum_documento==="")
                  {
                    alert('No hay documento')
                  }else{
                    Insert_header_fact(txt_nombre_serie,txtid_serie, txtid_sucursal,txtnum_documento, 'insert_tbl_compra');
                  }
      ...
      function Insert_header_fact(txt_nombre_serie,txtid_serie, txtid_sucursal, txtnum_documento,Method) {
       
       var parametros = {
        "txt_nombre_serie": txt_nombre_serie,
         "txtid_serie": txtid_serie,
         "txtid_sucursal": txtid_sucursal,
         "txtnum_documento": txtnum_documento,
         "Method": Method
       };
       $.ajax({
         data: parametros,
         ...
         success: function(response) {
           ...
           //Limpiar();
           rows_detailts_insert(txt_nombre_serie);
           ftc_button.setAttribute("onclick",'recorrido_tabla();');
     ...
     function rows_detailts_insert(txt_nombre_serie)
     {
      if (parseInt(contador_de_tabla)>=1){
        try{
        for (let index = 1; index <= contador_de_tabla; index++) 
        {
          ...
          txtcantidad_compra= document.getElementById('tbl_cantidad'+index).innerHTML;
          txtprecio_con_iva= document.getElementById('tbl_precioiva'+index).innerHTML ;
          txtprecio_sin_iva= document.getElementById('tbl_precio'+index).innerHTML ;
          ...
          Insert_details_fact(txtid_bodega,txt_nombre_serie,txtimpuesto,txtcantidad_compra, txtprecio_con_iva,txtprecio_sin_iva,txtprecio,txtid_producto, 'insert_tbl_detalle_compra')
        }
     ...
     function Insert_details_fact(txtid_bodega,txt_nombre_serie,txtimpuesto,txtcantidad_compra, txtprecio_con_iva,txtprecio_sin_iva,txtprecio,txtid_producto, Method) {
      txtimpuesto = ParseSQL_Num(txtimpuesto);
      txtcantidad_compra = ParseSQL_Num(txtcantidad_compra);
      txtprecio_con_iva = ParseSQL_Num(txtprecio_con_iva);
      txtprecio = ParseSQL_Num(txtprecio);
      txtprecio_sin_iva = ParseSQL_Num(txtprecio_sin_iva);
    ...
    alert(txtid_bodega);
      ...
      var parametros = {
        ...
        "txtcantidad_compra": txtcantidad_compra,
        "txtprecio_con_iva": txtprecio_con_iva,
        "txtprecio_sin_iva": txtprecio_sin_iva,
        "txtprecio": txtprecio,
