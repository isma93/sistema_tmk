...
function mejora(){
  ...
  var x = <?php echo $_SESSION['Loader']; ?>

  if (x=true)
  {
    <?php $_SESSION['Loader']= false; ?>
  }
else {
...
<div class="load-animate animated fadeInUp">
			...
			<center><h1>REPORTES DE NOTAS INGRESADAS EXCEL</h1></center>
			</div>		    		
			</div>
			...
			<form action="exportexcelingresados.php" method="post" name="busqueda" class="" role="form" novalidate> 
                <br>
...
<div class="panel-body">
            ...
            <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3 pull-right">
							<div class= "form-group">
							<br><button onclick="mejora();" class="btn btn-info  btn-lg btn-block" id= "btn-search" name="btn_search" type="submit"> <h4><i class="fa fa-file-excel-o" aria-hidden="true"></i></i>  DESCARGAR REPORTE EXCEL</h5></button>
							</form>
