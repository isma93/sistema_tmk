...
<div class="load-animate animated fadeInUp">
			...
			<form action="arrayfechautpdfbodega.php" method="post" name="busqueda" class="" role="form" novalidate> 
                <br>
                                    ...
                                    <tr>
                                        <?php
                                                                  ...
                                                                  if (isset($_SESSION['min'])){
                                                                      if (isset($_SESSION['max'])){
                                                                        if (isset($_SESSION['autorizadores'])){
                                                                          ...
                                                                          $query="call SP_REPORTS_LLENAR_TABLA_FORMULARIO_BODEGA('$min','$max','$autorizadores')";
                                                  $resultado=mysqli_query( $conexion, $query ) or die ( "No se pueden mostrar los canales");
                                                ...
                                                while ($row=mysqli_fetch_array($resultado))
                                                    ...
                                                    ?> <td>  <a class="btn btn-success" href='fragmentvisor.php?id=<?php echo $idenvi;?>&com=<?php echo $i ?>' ><i class="fa fa-eye"></i> Ver</a> <?php echo '</td>';
                                                    ?> <?php
