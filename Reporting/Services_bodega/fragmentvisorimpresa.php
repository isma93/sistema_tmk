...
<a id="redirect" href="./ViewReportpdfbodega_impresa.php" class="" value="Print">.</a>
<br>
<div class="Container">

<iframe id="myIframe" name="myIframe" src="./Report_Notaimpresa.php?id=<?php echo $id_intr ?>&com=0" width=400 height=300 style="position:fixed; top:0px; left:0px; bottom:0px; right:0px; width:100%; height:100%; border:none; margin:0; padding:0; overflow:hidden; z-index:999999;">"No es posible visualizar el contenido"</iframe>
          ...
          <script>
            ...
            function Print(objetive_focus)
            {
              ...
              objetive_focus.setTimeout(function () {  alert("Hoja impresa!"); window.location = "ViewReportpdfbodega_impresa.php";}, 100);
