...
<div class="load-animate animated fadeInUp">
			...
			<center><h1>REPORTES DE NOTAS AUTORIZADAS E IMPRESAS</h1></center>
			</div>		    		
			</div>
			...
			<form action="arrayfechautpdf_impresa.php" method="post" name="busqueda" class="" role="form" novalidate> 
                <br>
                                    ...
                                    <tr>
                                        <?php
                                                                  ...
                                                                  if (isset($_SESSION['min'])){
                                                                      if (isset($_SESSION['max'])){
                                                                        if (isset($_SESSION['autorizadores'])){
                                                                          ...
                                                                          $query="call SP_REPORTS_LLENAR_TABLA_FORMULARIO_IMPRESAS('$min','$max','$autorizadores')";
                                                  $resultado=mysqli_query( $conexion, $query ) or die ( "No se pueden mostrar los canales");
                                                ...
                                                while ($row=mysqli_fetch_array($resultado))
                                                    ...
                                                    if ($row['id_estado']=1){
                                                        echo '<td> '; echo "Impreso";echo '</td>';
                                                                                }
                                                    
                                                    ?> <td>  <a class="btn btn-success" href='Report_Nota_impresa.php?id=<?php echo $idenvi;?>&com=<?php echo $i ?>' ><i class="fa fa-eye"></i> Ver</a> <?php echo '</td>';
                                                    ?> <?php
