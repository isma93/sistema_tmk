...
<div class="load-animate animated fadeInUp">
			...
			<center><h1>REPORTES DE ANULAR NOTAS DE EGRESO</h1></center>
			</div>		    		
			</div>
			...
			<form action="arrayfechautpdf_anular.php" method="post" name="busqueda" class="" role="form" novalidate> 
                <br>
...
<div class="panel-body">
         ...
         <br> 
            ...
            <select name="autorizadores" id="autorizadores"  class="form-control">
									<option value="0">Seleccione Informe de autorizacion</option>
                                    ...
                                    <tr>
                                        <?php
                                                                  ...
                                                                  if (isset($_SESSION['min'])){
                                                                      if (isset($_SESSION['max'])){
                                                                        if (isset($_SESSION['autorizadores'])){
                                                                          ...
                                                                          $query="call SP_REPORTS_LLENAR_TABLA_FORMULARIO_TODAS('$min','$max','$autorizadores')";
                                                  $resultado=mysqli_query( $conexion, $query ) or die ( "No se pueden mostrar los canales");
                                                ...
                                                while ($row=mysqli_fetch_array($resultado))
                                                    ...
                                                    if ($row['id_estado']=1){
                                                        echo '<td> '; echo "Autorizado";echo '</td>';
                                                                                }
                                                    
                                                    ?> <td>  <a class="btn btn-danger" href='viewanularegreso.php?id=<?php echo $idenvi;?>&com=<?php echo $i ?>' ><i class="fa fa-exclamation-triangle"></i> Revisar</a> <?php echo '</td>';
                                                    ?> <?php
