...
<?php
			...
			<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
				...
				<div class="form-group">
					...
					<form onsubmit="retrofilnull(event)" action="../AppCode/Eliminarnota.php" id="nullfill" method="post" class="invoice-form" role="form" novalidate> 
			
					<th width="100%">	<input <?php  ?>  id="anulado" data-loading-text="Guardando factura..." type="submit" name="anulado" value="Anular Nota" class="tn btn-danger	 btn-lg btn-block">											
																			</th>	
																			</tr>
																			</table>
			</div>
