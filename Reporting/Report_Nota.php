...
$query="insert into bitacora_estados_nota_egreso (id_empleado, id_estado, id_nota_egreso_interna, fecha_estado )values ('$codigo_empleado','15','$id_intr','$DateAndTime');";
$resultado=mysqli_query( $conexion, $query ) or die ( "No se pueden mostrar los canales");
 if ($resultado)
 {
   

    $query="UPDATE nota_egreso SET id_ultimo_estado = '15' where id_nota_egreso_interna = '$id_intr'";
    $resultado=mysqli_query( $conexion, $query ) or die ( "No se pueden mostrar los canales");
     if ($resultado)
     {
//FIN
...
$pdf -> MultiCell(140,5,utf8_decode($varcuenta),1,'L',1); 
$pdf->SetFont('Arial','',7);
$pdf -> MultiCell(50,4,utf8_decode("1-7110410 Prom. Mayorista \n 2-7110401 Muestra  \n 3-7110305 Exhibidores y Stand \n 4-7110402 Lanzamientos"),1,'L',1); 
//////////////////
$pdf -> setXY(62,$y+10); //(X,Y)
